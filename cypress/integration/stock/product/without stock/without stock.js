...
before(() => {
	...
	//create the product
	Categories.visit()
	Categories.deleteProductsNamedAs("Product without Stock")
	...
	ProductMaintenance.fillProdudctName("de", "Product without Stock")
	ProductMaintenance.fillProdudctName("en", "Product without Stock")
