...
before(() => {
	...
	//create the product
	Categories.visit()
	Categories.deleteProductsNamedAs("[P1A0] Product with attribute without Stock")
	...
	ProductMaintenance.fillProdudctName("de", "[P1A0] Product with attribute without Stock")
	ProductMaintenance.fillProdudctName("en", "[P1A0] Product with attribute without Stock")
	...
	Categories.visit()
	Categories.navigateProductAttributes("[P1A0] Product with attribute without Stock")
	ProductAttributes.clickLoadOptions("Attribute EN")
	ProductAttributes.configureOption("Attribute EN", 'Yes', {'checked': 'true', "sort_order": "1", "stock": 0})
	ProductAttributes.configureOption("Attribute EN", 'No', {'checked': 'true', "sort_order": "0", "stock": 0})
});